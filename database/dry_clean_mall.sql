...
CREATE TABLE `ai_chat_message`  (
  ...
  `source_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'KNOWLEDGE/OPENAI/FALLBACK',
...
) ENGINE = InnoDB AUTO_INCREMENT = 56 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'AI客服问答日志' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of ai_chat_message
-- ----------------------------
INSERT INTO `ai_chat_message` VALUES (1, NULL, '羽绒服干洗需要多久？', '羽绒服一般需要5-7天左右。旺季、厚款、长款或有顽固污渍时可能顺延1-2天；下单时可以在备注里说明取衣时间要求。', 'KNOWLEDGE', 1, '2026-07-18 13:09:15');
INSERT INTO `ai_chat_message` VALUES (2, NULL, '羽绒服干洗需要多久？', '羽绒服一般需要5-7天左右。旺季、厚款、长款或有顽固污渍时可能顺延1-2天；下单时可以在备注里说明取衣时间要求。', 'KNOWLEDGE', 1, '2026-07-18 13:10:55');
INSERT INTO `ai_chat_message` VALUES (3, NULL, '羽绒服干洗需要多久？', '羽绒服一般需要5-7天左右。旺季、厚款、长款或有顽固污渍时可能顺延1-2天；下单时可以在备注里说明取衣时间要求。', 'KNOWLEDGE', 1, '2026-07-18 13:11:27');
INSERT INTO `ai_chat_message` VALUES (4, NULL, '皮衣护理怎么收费？', '毛毯按尺寸和厚度收费，小毛毯60元起，中毛毯80元起，大毛毯100元起，加厚款会加收护理费。', 'KNOWLEDGE', 22, '2026-07-18 13:11:29');
INSERT INTO `ai_chat_message` VALUES (5, NULL, '哪些衣物不适合水洗？', '羊绒羊毛、真丝、皮革、含涂层面料、结构复杂礼服、易褪色深色衣物不建议普通水洗，应按洗标选择专业干洗或精洗。', 'KNOWLEDGE', 17, '2026-07-18 13:11:32');
INSERT INTO `ai_chat_message` VALUES (6, NULL, '如果我想要清洗鞋子可以选择什么下单', '知识库暂时没有找到完全匹配的答案。当前未配置 OpenAI API Key，请在后端环境变量 OPENAI_API_KEY 中配置后重启服务，我就可以继续为你解答更开放的问题。', 'FALLBACK', NULL, '2026-07-18 13:19:11');
INSERT INTO `ai_chat_message` VALUES (7, NULL, '我现在想清洗鞋子可以选择什么服务', '知识库暂时没有找到完全匹配的答案。当前未配置 OpenAI API Key，请在后端环境变量 OPENAI_API_KEY 中配置后重启服务，我就可以继续为你解答更开放的问题。', 'FALLBACK', NULL, '2026-07-18 13:19:34');
INSERT INTO `ai_chat_message` VALUES (8, NULL, '我现在想清洗鞋子可以选择什么服务', '我暂时没有从知识库或 AI 服务获得稳定答案。你可以换一种问法，或联系门店客服处理具体订单问题。', 'FALLBACK', NULL, '2026-07-18 13:26:11');
INSERT INTO `ai_chat_message` VALUES (9, NULL, '皮衣护理怎么收费？', '毛毯按尺寸和厚度收费，小毛毯60元起，中毛毯80元起，大毛毯100元起，加厚款会加收护理费。', 'KNOWLEDGE', 22, '2026-07-18 13:27:56');
INSERT INTO `ai_chat_message` VALUES (10, NULL, '我想清洗鞋子可以选什么服务', '我暂时没有从知识库或 AI 服务获得稳定答案。你可以换一种问法，或联系门店客服处理具体订单问题。', 'FALLBACK', NULL, '2026-07-18 13:28:43');
INSERT INTO `ai_chat_message` VALUES (11, NULL, '衣服洗坏了怎么办？', '请第一时间保留衣物、订单和照片，在订单售后或门店联系工作人员。平台会根据收衣检查记录、洗标和实际情况协助处理。', 'KNOWLEDGE', 15, '2026-07-18 13:29:02');
INSERT INTO `ai_chat_message` VALUES (12, NULL, '我想清洗鞋子可以选什么服务', 'OpenAI API 已接入，但调用失败：I/O error on POST request for \"https://api.openai.com/v1/responses\": Connection timed out: connect; nested exception is java.net.ConnectException: Connection timed out: connect', 'FALLBACK', NULL, '2026-07-18 13:30:43');
INSERT INTO `ai_chat_message` VALUES (13, NULL, '西装可以当天取吗？', '部分普通衣物支持加急，需要门店确认排单和面料情况。羽绒服、皮衣、奢侈品护理通常不建议强行加急。', 'KNOWLEDGE', 13, '2026-07-18 13:32:09');
INSERT INTO `ai_chat_message` VALUES (14, NULL, '如果我想要清洗鞋子需要选择什么服务', 'OpenAI API 已接入，但调用失败：I/O error on POST request for \"https://api.openai.com/v1/responses\": Connection timed out: connect; nested exception is java.net.ConnectException: Connection timed out: connect', 'FALLBACK', NULL, '2026-07-18 13:32:56');
INSERT INTO `ai_chat_message` VALUES (15, NULL, '我想清洗鞋子可以选择什么服务', '您可以选择以下几种鞋子清洗服务：\n- 皮鞋护理：起步价25.00元，适用于普通皮鞋、真皮皮鞋、漆皮鞋等，提供清洗、上油、保养。\n- 运动鞋清洗：起步价28.00元，适用于普通运动鞋、跑步鞋、篮球鞋等，提供去污、除臭、护理。\n- 雪地靴护理：起步价35.00元，适用于短筒、中筒、高筒雪地靴，提供清洁、保养。\n- 帆布鞋清洗：起步价18.00元，适用于低帮、高帮帆布鞋，提供清洗、晾干。\n- 靴子保养：起步价42.00元，适用于短靴、中筒靴、长筒靴等，提供清洁保养。\n\n请根据您的鞋子类型选择合适的服务。', 'ZHIPU', NULL, '2026-07-18 13:35:41');
INSERT INTO `ai_chat_message` VALUES (16, NULL, '我想清洗鞋子可以选择什么服务', '您可以选择以下几种鞋子清洗服务：\n- 皮鞋护理：针对普通皮鞋、真皮皮鞋、漆皮鞋、磨砂皮鞋进行清洗、上油、保养。\n- 运动鞋清洗：针对普通运动鞋、跑步鞋、篮球鞋、限量版运动鞋进行去污、除臭、护理。\n- 雪地靴护理：针对短筒雪地靴、中筒雪地靴、高筒雪地靴、皮毛一体雪地靴进行清洁、保养。\n- 帆布鞋清洗：针对低帮帆布鞋、高帮帆布鞋、彩色帆布鞋、限量款帆布鞋进行清洗、晾干。\n- 靴子保养：针对短靴、中筒靴、长筒靴、过膝靴进行清洁保养。\n\n请根据您的鞋子类型选择合适的服务。', 'ZHIPU', NULL, '2026-07-18 13:36:24');
INSERT INTO `ai_chat_message` VALUES (17, NULL, '我需要清洗鞋子该选择什么服务', '您需要清洗鞋子，可以选择以下服务：\n\n1. 皮鞋护理：起步价25.00元，适用于普通皮鞋、真皮皮鞋、漆皮鞋等，提供清洗、上油、保养服务。\n2. 运动鞋清洗：起步价28.00元，适用于普通运动鞋、跑步鞋、篮球鞋等，提供去污、除臭、护理服务。\n3. 雪地靴护理：起步价35.00元，适用于短筒、中筒、高筒雪地靴，提供清洁、保养服务。\n4. 帆布鞋清洗：起步价18.00元，适用于低帮、高帮帆布鞋，提供清洗、晾干服务。\n5. 靴子保养：起步价42.00元，适用于短靴、中筒靴、长筒靴等，提供清洁保养服务。\n\n请根据您的鞋子类型选择合适的服务。', 'ZHIPU', NULL, '2026-07-18 13:37:26');
INSERT INTO `ai_chat_message` VALUES (18, NULL, '我需要清洗鞋子该选择什么服务', '您需要清洗鞋子，可以选择以下服务：\n\n1. **皮鞋护理**：起步价25.00元，适用于普通皮鞋、真皮皮鞋、漆皮鞋等，提供清洗、上油、保养服务，周期为3-5天左右。\n\n2. **运动鞋清洗**：起步价28.00元，适用于普通运动鞋、跑步鞋、篮球鞋等，提供去污、除臭、护理服务，周期为5-7天左右。\n\n3. **雪地靴护理**：起步价35.00元，适用于短筒、中筒、高筒雪地靴，提供清洁、保养服务，周期为5-7天左右。\n\n4. **帆布鞋清洗**：起步价18.00元，适用于低帮、高帮帆布鞋，提供清洗、晾干服务，周期为3-5天左右。\n\n5. **靴子保养**：起步价42.00元，适用于短靴、中筒靴、长筒靴等，提供清洁保养服务，周期为6-8天左右。\n\n6. **凉鞋护理**：起步价20.00元，适用于普通凉鞋、皮质凉鞋、高跟鞋等，提供清洗、消毒服务，周期为3-4天左右。\n\n请根据您的鞋子类型和需求选择合适的服务。', 'ZHIPU', NULL, '2026-07-18 13:53:10');
INSERT INTO `ai_chat_message` VALUES (19, NULL, '我想到清洗鞋子需要选择什么服务', '您可以选择“鞋类清洗”服务。我们提供多种鞋类清洗服务，包括普通皮鞋、真皮皮鞋、漆皮鞋、磨砂皮鞋等，以及运动鞋、雪地靴、帆布鞋等。每个服务都有不同的起步价和周期，可以根据您的鞋子类型和需求进行选择。请访问我们的网站或联系门店客服获取更多详细信息。', 'ZHIPU', NULL, '2026-07-18 13:56:05');
INSERT INTO `ai_chat_message` VALUES (20, NULL, '哪些衣物不适合水洗？', '羊绒羊毛、真丝、皮革、含涂层面料、结构复杂礼服、易褪色深色衣物不建议普通水洗，应按洗标选择专业干洗或精洗。', 'KNOWLEDGE', 17, '2026-07-18 13:56:52');
INSERT INTO `ai_chat_message` VALUES (21, NULL, '我需要预约运动鞋干洗', '您好，关于运动鞋干洗，我们的服务包括普通运动鞋、跑步鞋、篮球鞋等，起步价为28.00元。请您选择具体的运动鞋类型和数量，然后前往“我的订单”页面进行预约。如果您需要帮助或有其他疑问，请随时联系我们的客服。', 'ZHIPU', NULL, '2026-07-18 14:34:04');
INSERT INTO `ai_chat_message` VALUES (22, NULL, '我需要清洗运动鞋', '运动鞋、帆布鞋一般3-7天；皮鞋护理约3-5天；雪地靴和长靴通常5-8天。特殊材质或补色会延长。', 'KNOWLEDGE', 10, '2026-07-18 15:11:33');
INSERT INTO `ai_chat_message` VALUES (23, NULL, '帮我下载运动鞋的订单', '很抱歉，当前网站未配置下载订单的功能。您可以查看“我的订单”页面来了解您的订单详情，或者联系门店客服获取帮助。请问您需要我为您指引如何查看“我的订单”吗？或者有其他需要帮助的地方？', 'ZHIPU', NULL, '2026-07-18 15:11:47');
INSERT INTO `ai_chat_message` VALUES (24, NULL, '帮我下一个运动鞋的订单', '好的，请问您需要清洗哪种类型的运动鞋？比如普通运动鞋、跑步鞋、篮球鞋等。另外，您需要选择哪种清洗服务？例如基础清洗、深度清洗或者除臭护理等。提供这些信息后，我可以帮您下单。', 'ZHIPU', NULL, '2026-07-18 15:12:04');
INSERT INTO `ai_chat_message` VALUES (25, NULL, '基础清洗，普通运动鞋', '基础清洗普通运动鞋的服务，起步价为28.00元，周期为5-7天左右。服务内容包括去污、除臭和护理。如果您需要此服务，请前往附近门店或在线下单。当前网站未配置该信息，请查看干洗服务、商城、附近门店、我的订单或联系门店客服获取更多帮助。', 'ZHIPU', NULL, '2026-07-18 15:12:24');
INSERT INTO `ai_chat_message` VALUES (26, 10, '帮我下单一个运动鞋干洗服务', '好的，请告诉我您需要干洗的运动鞋的款式和数量，以及您所在的地址，我将为您下单。', 'ZHIPU', NULL, '2026-07-18 15:43:42');
INSERT INTO `ai_chat_message` VALUES (27, 10, '帮我下单一个运动鞋干洗服务', '好的，请问您需要清洗的运动鞋是普通款、跑步鞋、篮球鞋还是限量版？以及您希望选择哪个门店进行服务？', 'ZHIPU', NULL, '2026-07-18 15:44:09');
INSERT INTO `ai_chat_message` VALUES (28, 10, '帮我下单一个清洗运动鞋的订单‘', '好的，请问您需要清洗的运动鞋是普通款、跑步鞋、篮球鞋还是限量版？以及您希望清洗的数量是多少？', 'ZHIPU', NULL, '2026-07-18 16:17:50');
INSERT INTO `ai_chat_message` VALUES (29, 10, '我需要查询一下我昨天的订单', '我查到你最近的订单：\n- 订单号：DC1784365099271CF3B，类型：干洗服务，状态：待处理，支付：未支付，金额：69.00元，服务：西装干洗，取衣日期：2026-07-21\n- 订单号：DC1784362595400DF4B，类型：干洗服务，状态：待处理，支付：未支付，金额：98.00元，服务：羊绒大衣干洗，取衣日期：2026-07-23\n- 订单号：DC178436256192596AC，类型：干洗服务，状态：AWAIT_PICKUP，支付：已支付，金额：28.00元，服务：运动鞋清洗，取衣日期：2026-07-23\n- 订单号：DC1784354837663113F，类型：商城商品，状态：AWAIT_SHIP，支付：已支付，金额：39.90元，商品：浓缩洗衣液（3kg）\n- 订单号：DC178435483761857CA，类型：干洗服务，状态：AWAIT_PICKUP，支付：已支付，金额：69.00元，服务：羽绒服干洗，取衣日期：2026-07-21\n更完整的信息可以在“我的订单”页面查看。', 'BUSINESS', NULL, '2026-07-19 09:03:44');
INSERT INTO `ai_chat_message` VALUES (30, 29, '羽绒服干洗需要多久？', '羽绒服一般需要5-7天左右。旺季、厚款、长款或有顽固污渍时可能顺延1-2天；下单时可以在备注里说明取衣时间要求。', 'KNOWLEDGE', 1, '2026-07-19 10:14:53');
INSERT INTO `ai_chat_message` VALUES (31, 10, '我需要干洗一件羊毛大衣', '羊绒、羊毛大衣建议专业干洗。我们会先检查洗标和污渍，再进行预处理、低温清洗、整形熨烫，减少缩水和变形风险。', 'KNOWLEDGE', 3, '2026-07-19 11:02:38');
INSERT INTO `ai_chat_message` VALUES (32, 29, '西装怎么收费？', '西装上衣69元起，上衣+裤子套装99元起，三件套含马甲129元起。最终价格会根据规格和实际材质确认。', 'KNOWLEDGE', 2, '2026-07-19 17:19:07');
INSERT INTO `ai_chat_message` VALUES (33, 29, '我的需要清洗毛衣', '当前可预约的干洗服务有：\n- 衬衫洗烫：15.00元起，规格：普通衬衫|15;免烫衬衫|20;真丝衬衫|35;长袖/短袖同价，周期：2-3天左右\n- T恤清洗：12.00元起，规格：短袖T恤|12;长袖T恤|15;印花T恤|18;情侣款同价，周期：2-3天左右\n- 牛仔裤清洗：18.00元起，规格：普通牛仔裤|18;加厚牛仔裤|22;破洞牛仔裤|25;弹力牛仔裤|20，周期：2-4天左右\n- 运动服清洗：22.00元起，规格：运动T恤|22;运动裤|25;运动套装|42;瑜伽服|28，周期：2-4天左右\n- 皮鞋护理：25.00元起，规格：普通皮鞋|25;真皮皮鞋|35;漆皮鞋|30;磨砂皮|40，周期：3-5天左右\n你可以到“干洗服务”页面选择对应服务预约。', 'BUSINESS', NULL, '2026-07-19 17:19:22');
INSERT INTO `ai_chat_message` VALUES (34, 29, '我需要清洗毛衣', '当前可预约的干洗服务有：\n- 衬衫洗烫：15.00元起，规格：普通衬衫|15;免烫衬衫|20;真丝衬衫|35;长袖/短袖同价，周期：2-3天左右\n- T恤清洗：12.00元起，规格：短袖T恤|12;长袖T恤|15;印花T恤|18;情侣款同价，周期：2-3天左右\n- 牛仔裤清洗：18.00元起，规格：普通牛仔裤|18;加厚牛仔裤|22;破洞牛仔裤|25;弹力牛仔裤|20，周期：2-4天左右\n- 运动服清洗：22.00元起，规格：运动T恤|22;运动裤|25;运动套装|42;瑜伽服|28，周期：2-4天左右\n- 皮鞋护理：25.00元起，规格：普通皮鞋|25;真皮皮鞋|35;漆皮鞋|30;磨砂皮|40，周期：3-5天左右\n你可以到“干洗服务”页面选择对应服务预约。', 'BUSINESS', NULL, '2026-07-19 17:19:39');
INSERT INTO `ai_chat_message` VALUES (35, 29, '我需要清洗运动鞋', '运动鞋、帆布鞋一般3-7天；皮鞋护理约3-5天；雪地靴和长靴通常5-8天。特殊材质或补色会延长。', 'KNOWLEDGE', 10, '2026-07-19 17:19:50');
INSERT INTO `ai_chat_message` VALUES (36, 29, '帮我下单一个运动鞋的订单', '我查到你最近的订单：\n- 订单号：DC1784452713339BD4B，类型：干洗服务，状态：已取消，支付：未支付，金额：128.00元，服务：羽绒服干洗，取衣日期：2026-07-24\n- 订单号：DC17844526826975DA7，类型：商城商品，状态：AWAIT_SHIP，支付：已支付，金额：39.90元，商品：浓缩洗衣液（3kg）\n- 订单号：DC1784452683033F0AA，类型：商城商品，状态：AWAIT_SHIP，支付：已支付，金额：29.90元，商品：衣物柔顺剂（1.5L）\n- 订单号：DC1784443081929BF68，类型：干洗服务，状态：AWAIT_PICKUP，支付：已支付，金额：69.00元，服务：西装干洗，取衣日期：2026-07-22\n- 订单号：DC17844430821125948，类型：商城商品，状态：AWAIT_SHIP，支付：已支付，金额：29.90元，商品：衣物柔顺剂（1.5L）\n更完整的信息可以在“我的订单”页面查看。', 'BUSINESS', NULL, '2026-07-19 17:20:05');
INSERT INTO `ai_chat_message` VALUES (37, 29, '清洗运动鞋的流程是什么', '当前可预约的干洗服务有：\n- 衬衫洗烫：15.00元起，规格：普通衬衫|15;免烫衬衫|20;真丝衬衫|35;长袖/短袖同价，周期：2-3天左右\n- T恤清洗：12.00元起，规格：短袖T恤|12;长袖T恤|15;印花T恤|18;情侣款同价，周期：2-3天左右\n- 牛仔裤清洗：18.00元起，规格：普通牛仔裤|18;加厚牛仔裤|22;破洞牛仔裤|25;弹力牛仔裤|20，周期：2-4天左右\n- 运动服清洗：22.00元起，规格：运动T恤|22;运动裤|25;运动套装|42;瑜伽服|28，周期：2-4天左右\n- 皮鞋护理：25.00元起，规格：普通皮鞋|25;真皮皮鞋|35;漆皮鞋|30;磨砂皮|40，周期：3-5天左右\n你可以到“干洗服务”页面选择对应服务预约。', 'BUSINESS', NULL, '2026-07-19 17:20:29');
INSERT INTO `ai_chat_message` VALUES (38, 10, '你们是怎么清洗运动鞋的', '当前可预约的干洗服务有：\n- 衬衫洗烫：15.00元起，规格：普通衬衫|15;免烫衬衫|20;真丝衬衫|35;长袖/短袖同价，周期：2-3天左右\n- T恤清洗：12.00元起，规格：短袖T恤|12;长袖T恤|15;印花T恤|18;情侣款同价，周期：2-3天左右\n- 牛仔裤清洗：18.00元起，规格：普通牛仔裤|18;加厚牛仔裤|22;破洞牛仔裤|25;弹力牛仔裤|20，周期：2-4天左右\n- 运动服清洗：22.00元起，规格：运动T恤|22;运动裤|25;运动套装|42;瑜伽服|28，周期：2-4天左右\n- 皮鞋护理：25.00元起，规格：普通皮鞋|25;真皮皮鞋|35;漆皮鞋|30;磨砂皮|40，周期：3-5天左右\n你可以到“干洗服务”页面选择对应服务预约。', 'BUSINESS', NULL, '2026-07-19 17:21:51');
INSERT INTO `ai_chat_message` VALUES (39, 10, '清洗运动鞋的流程', '运动鞋、帆布鞋一般3-7天；皮鞋护理约3-5天；雪地靴和长靴通常5-8天。特殊材质或补色会延长。', 'KNOWLEDGE', 10, '2026-07-19 17:22:14');
INSERT INTO `ai_chat_message` VALUES (40, 29, '洗护用品商城是什么？', '商城提供洗衣液、柔顺剂、衣物除菌液、去渍笔、防串色片、鞋类护理剂等洗护用品，可和干洗服务一起下单。', 'KNOWLEDGE', 24, '2026-07-19 17:24:05');
INSERT INTO `ai_chat_message` VALUES (41, 29, '衣服洗坏了怎么办？', '请第一时间保留衣物、订单和照片，在订单售后或门店联系工作人员。平台会根据收衣检查记录、洗标和实际情况协助处理。', 'KNOWLEDGE', 15, '2026-07-19 17:24:14');
INSERT INTO `ai_chat_message` VALUES (42, 29, '可以上门取衣吗？', '支持上门取衣。你可以在下单时选择地址并填写联系电话，门店会按预约时段联系取件；部分偏远区域可能需要人工确认服务范围。', 'KNOWLEDGE', 5, '2026-07-19 17:24:18');
INSERT INTO `ai_chat_message` VALUES (43, 29, '西装怎么收费？', '西装上衣69元起，上衣+裤子套装99元起，三件套含马甲129元起。最终价格会根据规格和实际材质确认。', 'KNOWLEDGE', 2, '2026-07-19 17:24:20');
INSERT INTO `ai_chat_message` VALUES (44, 29, '羽绒服干洗需要多久？', '羽绒服一般需要5-7天左右。旺季、厚款、长款或有顽固污渍时可能顺延1-2天；下单时可以在备注里说明取衣时间要求。', 'KNOWLEDGE', 1, '2026-07-19 17:24:22');
INSERT INTO `ai_chat_message` VALUES (45, 29, '衬衫清洗价格是多少', '当前可预约的干洗服务有：\n- 衬衫洗烫：15.00元起，规格：普通衬衫|15;免烫衬衫|20;真丝衬衫|35;长袖/短袖同价，周期：2-3天左右\n- T恤清洗：12.00元起，规格：短袖T恤|12;长袖T恤|15;印花T恤|18;情侣款同价，周期：2-3天左右\n- 牛仔裤清洗：18.00元起，规格：普通牛仔裤|18;加厚牛仔裤|22;破洞牛仔裤|25;弹力牛仔裤|20，周期：2-4天左右\n- 运动服清洗：22.00元起，规格：运动T恤|22;运动裤|25;运动套装|42;瑜伽服|28，周期：2-4天左右\n- 皮鞋护理：25.00元起，规格：普通皮鞋|25;真皮皮鞋|35;漆皮鞋|30;磨砂皮|40，周期：3-5天左右\n你可以到“干洗服务”页面选择对应服务预约。', 'BUSINESS', NULL, '2026-07-19 17:24:39');
INSERT INTO `ai_chat_message` VALUES (46, 29, '衣服洗坏了怎么办？', '请第一时间保留衣物、订单和照片，在订单售后或门店联系工作人员。平台会根据收衣检查记录、洗标和实际情况协助处理。', 'KNOWLEDGE', 15, '2026-07-19 17:25:02');
INSERT INTO `ai_chat_message` VALUES (47, 10, '我需要清洗运动鞋请帮我下单', '当前可预约的干洗服务有：\n- 衬衫洗烫：15.00元起，规格：普通衬衫|15;免烫衬衫|20;真丝衬衫|35;长袖/短袖同价，周期：2-3天左右\n- T恤清洗：12.00元起，规格：短袖T恤|12;长袖T恤|15;印花T恤|18;情侣款同价，周期：2-3天左右\n- 牛仔裤清洗：18.00元起，规格：普通牛仔裤|18;加厚牛仔裤|22;破洞牛仔裤|25;弹力牛仔裤|20，周期：2-4天左右\n- 运动服清洗：22.00元起，规格：运动T恤|22;运动裤|25;运动套装|42;瑜伽服|28，周期：2-4天左右\n- 皮鞋护理：25.00元起，规格：普通皮鞋|25;真皮皮鞋|35;漆皮鞋|30;磨砂皮|40，周期：3-5天左右\n你可以到“干洗服务”页面选择对应服务预约。', 'BUSINESS', NULL, '2026-07-19 18:20:28');
INSERT INTO `ai_chat_message` VALUES (48, 10, '帮我下单一个清洗运动鞋的订单', '我查到你最近的订单：\n- 订单号：DC178444505178229BE，类型：干洗服务，状态：AWAIT_PICKUP，支付：已支付，金额：69.00元，服务：西装干洗，取衣日期：2026-07-22\n- 订单号：DC1784443393514E876，类型：干洗服务，状态：AWAIT_PICKUP，支付：已支付，金额：99.00元，服务：西装干洗，取衣日期：2026-07-22\n- 订单号：DC178444325243852F5，类型：干洗服务，状态：AWAIT_PICKUP，支付：已支付，金额：99.00元，服务：西装干洗，取衣日期：2026-07-22\n- 订单号：DC1784443252463F743，类型：干洗服务，状态：AWAIT_PICKUP，支付：已支付，金额：69.00元，服务：西装干洗，取衣日期：2026-07-22\n- 订单号：DC1784443061259387D，类型：干洗服务，状态：AWAIT_DROP，支付：已支付，金额：99.00元，服务：西装干洗，取衣日期：2026-07-22\n更完整的信息可以在“我的订单”页面查看。', 'BUSINESS', NULL, '2026-07-19 18:41:36');
INSERT INTO `ai_chat_message` VALUES (49, 10, '帮我下单一个清洗运动鞋的订单', '我查到你最近的订单：\n- 订单号：DC178444505178229BE，类型：干洗服务，状态：AWAIT_PICKUP，支付：已支付，金额：69.00元，服务：西装干洗，取衣日期：2026-07-22\n- 订单号：DC1784443393514E876，类型：干洗服务，状态：AWAIT_PICKUP，支付：已支付，金额：99.00元，服务：西装干洗，取衣日期：2026-07-22\n- 订单号：DC178444325243852F5，类型：干洗服务，状态：AWAIT_PICKUP，支付：已支付，金额：99.00元，服务：西装干洗，取衣日期：2026-07-22\n- 订单号：DC1784443252463F743，类型：干洗服务，状态：AWAIT_PICKUP，支付：已支付，金额：69.00元，服务：西装干洗，取衣日期：2026-07-22\n- 订单号：DC1784443061259387D，类型：干洗服务，状态：AWAIT_DROP，支付：已支付，金额：99.00元，服务：西装干洗，取衣日期：2026-07-22\n更完整的信息可以在“我的订单”页面查看。', 'BUSINESS', NULL, '2026-07-19 18:42:02');
INSERT INTO `ai_chat_message` VALUES (50, 10, '帮我下单一个运动鞋', '当前可预约的干洗服务有：\n- 运动服清洗：22.00元起，规格：运动T恤|22;运动裤|25;运动套装|42;瑜伽服|28，周期：2-4天左右\n- 运动鞋清洗：28.00元起，规格：普通运动鞋|28;跑步鞋|32;篮球鞋|38;限量版|48，周期：5-7天左右\n- 背包清洗：22.00元起，规格：双肩包|22;单肩包|25;帆布包|20;真皮包|45;运动背包|28，周期：4-6天左右\n你可以到“干洗服务”页面选择对应服务预约。', 'BUSINESS', NULL, '2026-07-19 18:44:50');
INSERT INTO `ai_chat_message` VALUES (51, 10, '帮我下单一个清洗运动鞋的订单', '我查到你最近的订单：\n- 订单号：DC178444505178229BE，类型：干洗服务，状态：AWAIT_PICKUP，支付：已支付，金额：69.00元，服务：西装干洗，取衣日期：2026-07-22\n- 订单号：DC1784443393514E876，类型：干洗服务，状态：AWAIT_PICKUP，支付：已支付，金额：99.00元，服务：西装干洗，取衣日期：2026-07-22\n- 订单号：DC178444325243852F5，类型：干洗服务，状态：AWAIT_PICKUP，支付：已支付，金额：99.00元，服务：西装干洗，取衣日期：2026-07-22\n- 订单号：DC1784443252463F743，类型：干洗服务，状态：AWAIT_PICKUP，支付：已支付，金额：69.00元，服务：西装干洗，取衣日期：2026-07-22\n- 订单号：DC1784443061259387D，类型：干洗服务，状态：AWAIT_DROP，支付：已支付，金额：99.00元，服务：西装干洗，取衣日期：2026-07-22\n更完整的信息可以在“我的订单”页面查看。', 'BUSINESS', NULL, '2026-07-19 18:47:04');
INSERT INTO `ai_chat_message` VALUES (52, 10, '帮我下单一个清洗运动鞋的订单', '我查到你最近的订单：\n- 订单号：DC178444505178229BE，类型：干洗服务，状态：AWAIT_PICKUP，支付：已支付，金额：69.00元，服务：西装干洗，取衣日期：2026-07-22\n- 订单号：DC1784443393514E876，类型：干洗服务，状态：AWAIT_PICKUP，支付：已支付，金额：99.00元，服务：西装干洗，取衣日期：2026-07-22\n- 订单号：DC178444325243852F5，类型：干洗服务，状态：AWAIT_PICKUP，支付：已支付，金额：99.00元，服务：西装干洗，取衣日期：2026-07-22\n- 订单号：DC1784443252463F743，类型：干洗服务，状态：AWAIT_PICKUP，支付：已支付，金额：69.00元，服务：西装干洗，取衣日期：2026-07-22\n- 订单号：DC1784443061259387D，类型：干洗服务，状态：AWAIT_DROP，支付：已支付，金额：99.00元，服务：西装干洗，取衣日期：2026-07-22\n更完整的信息可以在“我的订单”页面查看。', 'BUSINESS', NULL, '2026-07-19 18:48:28');
INSERT INTO `ai_chat_message` VALUES (53, 10, '帮我下单一个清洗运动鞋的顶顶那', '当前可预约的干洗服务有：\n- 衬衫洗烫：15.00元起，规格：普通衬衫|15;免烫衬衫|20;真丝衬衫|35;长袖/短袖同价，周期：2-3天左右\n- T恤清洗：12.00元起，规格：短袖T恤|12;长袖T恤|15;印花T恤|18;情侣款同价，周期：2-3天左右\n- 牛仔裤清洗：18.00元起，规格：普通牛仔裤|18;加厚牛仔裤|22;破洞牛仔裤|25;弹力牛仔裤|20，周期：2-4天左右\n- 运动服清洗：22.00元起，规格：运动T恤|22;运动裤|25;运动套装|42;瑜伽服|28，周期：2-4天左右\n- 皮鞋护理：25.00元起，规格：普通皮鞋|25;真皮皮鞋|35;漆皮鞋|30;磨砂皮|40，周期：3-5天左右\n你可以到“干洗服务”页面选择对应服务预约。', 'BUSINESS', NULL, '2026-07-19 18:49:02');
INSERT INTO `ai_chat_message` VALUES (54, 10, '帮我', '您好，请问有什么可以帮助您的？您可以告诉我您需要的服务或者商品，我会尽力为您提供相关信息。', 'ZHIPU', NULL, '2026-07-19 18:53:00');
INSERT INTO `ai_chat_message` VALUES (55, 10, '帮我下单一个清洗运动鞋的订单', '可以的，我帮你匹配到“运动鞋清洗”。运动鞋清洗：28.00元起，规格：普通运动鞋28元、跑步鞋32元、篮球鞋38元、限量版48元，周期：5-7天左右\n\n请在“干洗服务”页面选择该服务，确认规格、地址和取送时间后提交订单；如果是特殊材质或限量款，建议在备注里写清楚。', 'BUSINESS', NULL, '2026-07-19 18:54:02');
...
-- ----------------------------
INSERT INTO `ai_knowledge` VALUES (1, '羽绒服干洗需要多久？', '羽绒服一般需要5-7天左右。旺季、厚款、长款或有顽固污渍时可能顺延1-2天；下单时可以在备注里说明取衣时间要求。', '洗护周期', '羽绒服,多久,周期,取衣,加急', 1, 1, 5, '2026-03-19 00:20:00', '2026-07-19 17:24:22');
INSERT INTO `ai_knowledge` VALUES (2, '西装干洗怎么收费？', '西装上衣69元起，上衣+裤子套装99元起，三件套含马甲129元起。最终价格会根据规格和实际材质确认。', '价格规格', '西装,套装,价格,收费,马甲', 1, 2, 2, '2026-03-19 00:20:00', '2026-07-19 17:24:20');
INSERT INTO `ai_knowledge` VALUES (3, '羊绒大衣可以干洗吗？', '羊绒、羊毛大衣建议专业干洗。我们会先检查洗标和污渍，再进行预处理、低温清洗、整形熨烫，减少缩水和变形风险。', '洗护方式', '羊绒大衣,羊毛大衣,干洗,缩水,变形', 1, 3, 1, '2026-03-19 00:20:00', '2026-07-19 11:02:38');
...
INSERT INTO `ai_knowledge` VALUES (5, '可以上门取衣吗？', '支持上门取衣。你可以在下单时选择地址并填写联系电话，门店会按预约时段联系取件；部分偏远区域可能需要人工确认服务范围。', '取送服务', '上门,取衣,取件,地址,预约时段', 1, 5, 1, '2026-03-19 00:20:00', '2026-07-19 17:24:18');
...
INSERT INTO `ai_knowledge` VALUES (10, '鞋子清洗需要多久？', '运动鞋、帆布鞋一般3-7天；皮鞋护理约3-5天；雪地靴和长靴通常5-8天。特殊材质或补色会延长。', '洗护周期', '鞋子,运动鞋,皮鞋,雪地靴,长靴,多久', 1, 10, 3, '2026-03-19 00:20:00', '2026-07-19 17:22:14');
...
INSERT INTO `ai_knowledge` VALUES (13, '可以加急洗衣吗？', '部分普通衣物支持加急，需要门店确认排单和面料情况。羽绒服、皮衣、奢侈品护理通常不建议强行加急。', '订单服务', '加急,当天取,排单,普通衣物,门店确认', 1, 13, 1, '2026-03-19 00:20:00', '2026-03-19 00:20:00');
...
INSERT INTO `ai_knowledge` VALUES (15, '衣服洗坏了怎么处理？', '请第一时间保留衣物、订单和照片，在订单售后或门店联系工作人员。平台会根据收衣检查记录、洗标和实际情况协助处理。', '售后服务', '洗坏,赔付,售后,投诉,订单', 1, 15, 3, '2026-03-19 00:20:00', '2026-07-19 17:25:02');
...
INSERT INTO `ai_knowledge` VALUES (17, '哪些衣物不适合普通水洗？', '羊绒羊毛、真丝、皮革、含涂层面料、结构复杂礼服、易褪色深色衣物不建议普通水洗，应按洗标选择专业干洗或精洗。', '洗护方式', '不适合水洗,羊毛,真丝,皮革,礼服,洗标', 1, 17, 2, '2026-03-19 00:20:00', '2026-07-18 13:56:52');
...
INSERT INTO `ai_knowledge` VALUES (22, '毛毯清洗怎么收费？', '毛毯按尺寸和厚度收费，小毛毯60元起，中毛毯80元起，大毛毯100元起，加厚款会加收护理费。', '价格规格', '毛毯,尺寸,厚度,大件,价格', 1, 22, 2, '2026-03-19 00:20:00', '2026-03-19 00:20:00');
...
INSERT INTO `ai_knowledge` VALUES (24, '洗护用品商城卖什么？', '商城提供洗衣液、柔顺剂、衣物除菌液、去渍笔、防串色片、鞋类护理剂等洗护用品，可和干洗服务一起下单。', '商城商品', '洗护用品,洗衣液,柔顺剂,去渍笔,防串色片', 1, 24, 1, '2026-03-19 00:20:00', '2026-07-19 17:24:05');
...
INSERT INTO `cart_item` VALUES (56, 29, 'PRODUCT', 2, NULL, NULL, NULL, NULL, 1, '2026-07-19 17:19:04');
...
INSERT INTO `dry_service` VALUES (6, 'T恤清洗', '衣物', 12.00, '日常T恤清洗护理', 'https://tse3.mm.bing.net/th/id/OIP.9abLtCF_wMBefELCFnifAAHaHa?r=0&rs=1&pid=ImgDetMain&o=7&rm=3', 1, 6, '2026-03-06 15:12:10', '2026-07-18 13:12:30', '短袖T恤|12;长袖T恤|15;印花T恤|18;情侣款同价', '2-3天左右');
...
INSERT INTO `dry_service` VALUES (8, '牛仔裤清洗', '衣物', 18.00, '牛仔裤去渍、固色', 'https://img.alicdn.com/i4/1903800050/O1CN01lIqpi21CEwdvedcPg_!!1903800050.jpg', 1, 8, '2026-03-06 15:12:10', '2026-07-18 13:12:55', '普通牛仔裤|18;加厚牛仔裤|22;破洞牛仔裤|25;弹力牛仔裤|20', '2-4天左右');
...
INSERT INTO `dry_service` VALUES (12, '旗袍干洗', '衣物', 48.00, '旗袍、中式服装干洗', 'https://tse3.mm.bing.net/th/id/OIP.uEAN-oBDs2d8aw6diyq0oQHaJ4?r=0&rs=1&pid=ImgDetMain&o=7&rm=3', 1, 12, '2026-03-06 15:12:10', '2026-07-18 13:13:27', '短款旗袍|48;中长款旗袍|68;长款旗袍|88;真丝旗袍|108', '4-6天左右');
...
INSERT INTO `dry_service` VALUES (14, '皮鞋护理', '鞋类', 25.00, '皮鞋清洗、上油、保养', 'https://tse3.mm.bing.net/th/id/OIP.Ez9iSHfyIVq-dexrFfIPTAHaE7?r=0&rs=1&pid=ImgDetMain&o=7&rm=3', 1, 14, '2026-03-06 15:12:10', '2026-07-18 13:13:52', '普通皮鞋|25;真皮皮鞋|35;漆皮鞋|30;磨砂皮|40', '3-5天左右');
INSERT INTO `dry_service` VALUES (15, '运动鞋清洗', '鞋类', 28.00, '运动鞋去污、除臭、护理', 'https://tse3.mm.bing.net/th/id/OIP.2jlh-6qjEN8pUASy3RwyiQHaHa?r=0&rs=1&pid=ImgDetMain&o=7&rm=3', 1, 15, '2026-03-06 15:12:10', '2026-07-18 13:14:34', '普通运动鞋|28;跑步鞋|32;篮球鞋|38;限量版|48', '5-7天左右');
...
INSERT INTO `dry_service` VALUES (18, '靴子保养', '鞋类', 42.00, '长靴、短靴清洁保养', 'https://img.alicdn.com/i2/708668355/O1CN01f9AhlH2Badu1Qsx2P_!!708668355.jpg', 1, 18, '2026-03-06 15:12:10', '2026-07-18 13:16:36', '短靴|42;中筒靴|58;长筒靴|78;过膝靴|98', '6-8天左右');
...
INSERT INTO `dry_service` VALUES (20, '毛毯清洗', '其他', 60.00, '大件毛毯、盖毯清洗', 'https://tse4.mm.bing.net/th/id/OIP.r-0i2w6jdDrAzV2kM8RizQHaE7?r=0&rs=1&pid=ImgDetMain&o=7&rm=3', 1, 20, '2026-03-06 15:12:10', '2026-07-18 13:16:57', '小毛毯(1.5m)|60;中毛毯(1.8m)|80;大毛毯(2.0m)|100;加厚毛毯|+20', '7-10天左右');
...
INSERT INTO `dry_service` VALUES (24, '汽车坐垫清洗', '其他', 45.00, '汽车坐垫、靠垫清洗', 'https://tse1.mm.bing.net/th/id/OIP.xjwoE7q96rjmkvcHyVj3LgHaHa?r=0&rs=1&pid=ImgDetMain&o=7&rm=3', 1, 24, '2026-03-06 15:12:10', '2026-07-18 13:17:25', '前排两个|45;全套五座|98;真皮保养|+30;加厚坐垫|+15', '5-7天左右');
...
INSERT INTO `dry_service` VALUES (26, '背包清洗', '其他', 22.00, '双肩包、手提包清洗', 'https://tse1.mm.bing.net/th/id/OIP.-OGYWfiS_emHwqDqKdNQ_wHaE7?r=0&rs=1&pid=ImgDetMain&o=7&rm=3', 1, 26, '2026-03-06 15:12:10', '2026-07-18 13:17:51', '双肩包|22;单肩包|25;帆布包|20;真皮包|45;运动背包|28', '4-6天左右');
INSERT INTO `dry_service` VALUES (27, '帽子清洗', '其他', 15.00, '各类帽子清洗定型', 'https://tse3.mm.bing.net/th/id/OIP.F35PdscfyEyEm_jMhb-nUAHaE8?r=0&rs=1&pid=ImgDetMain&o=7&rm=3', 1, 27, '2026-03-06 15:12:10', '2026-07-18 13:18:08', '棒球帽|15;针织帽|15;遮阳帽|18;礼帽|25;真皮帽|35', '3-5天左右');
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '题目收藏' ROW_FORMAT = Dynamic;
...
INSERT INTO `mall_product` VALUES (7, '彩色衣物护色洗衣液', '洗衣液', 33.80, 'https://img.alicdn.com/i3/1609177584/O1CN01u95A0q25tWVaiJkgL_!!1609177584.jpg', 99, 59, 1, 7, '2026-03-07 15:18:45', '2026-07-19 08:54:17', '护色锁色，防止深色/彩色衣物串色褪色，机洗更安心。', '奥妙', '联合利华日化有限公司', '2026-02-18', '2kg/瓶');
...
) ENGINE = InnoDB AUTO_INCREMENT = 357 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '订单表' ROW_FORMAT = Dynamic;
...
INSERT INTO `order_info` VALUES (310, 'DC17732272009333BA7', 10, NULL, 2, 1, 29.90, 'SHIPPING', 'PAID', '2026-03-11 19:06:43', NULL, NULL, NULL, NULL, NULL, '', '2026-03-11 19:06:41', '2026-03-31 15:47:35', 2, 'DOOR_TO_DOOR', 2, 'PRODUCT', '2026-03-14', 0);
...
INSERT INTO `order_info` VALUES (320, 'DC1773850380831E5F1', 10, 2, NULL, 1, 69.00, 'COMPLETED', 'PAID', '2026-03-19 00:13:05', NULL, NULL, NULL, NULL, NULL, '[规格:短款] ', '2026-03-19 00:13:01', '2026-03-23 16:44:56', NULL, 'IN_STORE', 2, 'SERVICE', '2026-03-24', 1);
INSERT INTO `order_info` VALUES (321, 'DC1774255316650ABF5', 10, 2, NULL, 1, 69.00, 'PENDING', 'UNPAID', NULL, NULL, NULL, NULL, NULL, NULL, '[规格:短款] ', '2026-03-23 16:41:57', '2026-03-23 16:41:57', 2, 'DOOR_TO_DOOR', NULL, 'SERVICE', '2026-03-28', 0);
INSERT INTO `order_info` VALUES (322, 'DC17749423553364210', 10, 2, NULL, 1, 69.00, 'PENDING', 'UNPAID', NULL, NULL, NULL, NULL, NULL, NULL, '[规格:短款] ', '2026-03-31 15:32:35', '2026-03-31 15:32:35', NULL, 'IN_STORE', 2, 'SERVICE', '2026-04-05', 0);
INSERT INTO `order_info` VALUES (323, 'DC17752207812815B20', 10, 2, NULL, 1, 69.00, 'AWAIT_PICKUP', 'PAID', '2026-07-18 12:48:02', NULL, NULL, NULL, NULL, NULL, '[规格:短款] ', '2026-04-03 20:53:01', '2026-07-18 12:48:02', 2, 'DOOR_TO_DOOR', 2, 'SERVICE', '2026-04-08', 0);
INSERT INTO `order_info` VALUES (324, 'DC17752207856376FB2', 10, 3, NULL, 1, 98.00, 'PENDING', 'UNPAID', NULL, NULL, NULL, NULL, NULL, NULL, '[规格:短款] ', '2026-04-03 20:53:06', '2026-04-03 20:53:06', 2, 'DOOR_TO_DOOR', 2, 'SERVICE', '2026-04-08', 0);
INSERT INTO `order_info` VALUES (325, 'DC17843500735964760', 10, 3, NULL, 1, 98.00, 'PENDING', 'UNPAID', NULL, NULL, NULL, NULL, NULL, NULL, '[规格:短款] ', '2026-07-18 12:47:54', '2026-07-18 12:47:54', 12, 'DOOR_TO_DOOR', 3, 'SERVICE', '2026-07-21', 0);
INSERT INTO `order_info` VALUES (326, 'DC1784350073645E35C', 10, 2, NULL, 3, 207.00, 'PENDING', 'UNPAID', NULL, NULL, NULL, NULL, NULL, NULL, '[规格:短款] ', '2026-07-18 12:47:54', '2026-07-18 12:47:54', 12, 'DOOR_TO_DOOR', 3, 'SERVICE', '2026-07-21', 0);
INSERT INTO `order_info` VALUES (327, 'DC1784350073667D9D7', 10, NULL, 1, 3, 119.70, 'PENDING', 'UNPAID', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-07-18 12:47:54', '2026-07-18 12:47:54', 12, 'DOOR_TO_DOOR', 3, 'PRODUCT', NULL, 0);
INSERT INTO `order_info` VALUES (328, 'DC1784350978603A8F1', 10, 2, NULL, 1, 69.00, 'PENDING', 'UNPAID', NULL, NULL, NULL, NULL, NULL, NULL, '[规格:短款] ', '2026-07-18 13:02:59', '2026-07-18 13:02:59', 2, 'DOOR_TO_DOOR', 2, 'SERVICE', '2026-07-23', 1);
INSERT INTO `order_info` VALUES (329, 'DC178435483761857CA', 10, 2, NULL, 1, 69.00, 'AWAIT_PICKUP', 'PAID', '2026-07-18 14:07:24', NULL, NULL, NULL, NULL, NULL, '[规格:短款] ', '2026-07-18 14:07:18', '2026-07-18 14:07:24', 2, 'DOOR_TO_DOOR', 2, 'SERVICE', '2026-07-21', 0);
INSERT INTO `order_info` VALUES (330, 'DC1784354837663113F', 10, NULL, 1, 1, 39.90, 'AWAIT_SHIP', 'PAID', '2026-07-18 15:09:17', NULL, NULL, NULL, NULL, NULL, '', '2026-07-18 14:07:18', '2026-07-18 15:09:17', 2, 'DOOR_TO_DOOR', NULL, 'PRODUCT', NULL, 0);
INSERT INTO `order_info` VALUES (331, 'DC178436256192596AC', 10, 15, NULL, 1, 28.00, 'AWAIT_PICKUP', 'PAID', '2026-07-18 16:16:05', NULL, NULL, NULL, NULL, NULL, '[规格:普通运动鞋] ', '2026-07-18 16:16:02', '2026-07-18 16:16:05', 2, 'DOOR_TO_DOOR', 2, 'SERVICE', '2026-07-23', 0);
INSERT INTO `order_info` VALUES (332, 'DC1784362595400DF4B', 10, 3, NULL, 1, 98.00, 'PENDING', 'UNPAID', NULL, NULL, NULL, NULL, NULL, NULL, '[规格:短款] ', '2026-07-18 16:16:35', '2026-07-18 16:16:35', 2, 'DOOR_TO_DOOR', NULL, 'SERVICE', '2026-07-23', 0);
INSERT INTO `order_info` VALUES (333, 'DC1784365099271CF3B', 10, 1, NULL, 1, 69.00, 'PENDING', 'UNPAID', NULL, NULL, NULL, NULL, NULL, NULL, '[规格:上衣] ', '2026-07-18 16:58:19', '2026-07-18 16:58:19', 2, 'DOOR_TO_DOOR', NULL, 'SERVICE', '2026-07-21', 0);
INSERT INTO `order_info` VALUES (334, 'DC1784431559417BF4A', 29, 14, NULL, 1, 25.00, 'AWAIT_DROP', 'PAID', '2026-07-19 11:26:08', NULL, NULL, NULL, NULL, NULL, '[规格:普通皮鞋] ', '2026-07-19 11:25:59', '2026-07-19 11:26:08', 17, 'IN_STORE', 2, 'SERVICE', '2026-07-22', 0);
INSERT INTO `order_info` VALUES (335, 'DC1784431559509F8B4', 29, 1, NULL, 1, 69.00, 'AWAIT_DROP', 'PAID', '2026-07-19 11:26:03', NULL, NULL, NULL, NULL, NULL, '[规格:上衣] ', '2026-07-19 11:26:00', '2026-07-19 11:26:03', 17, 'IN_STORE', 2, 'SERVICE', '2026-07-22', 0);
INSERT INTO `order_info` VALUES (336, 'DC17844315595828046', 29, NULL, 1, 1, 39.90, 'AWAIT_SHIP', 'PAID', '2026-07-19 11:26:06', NULL, NULL, NULL, NULL, NULL, NULL, '2026-07-19 11:26:00', '2026-07-19 11:26:06', 17, 'IN_STORE', 2, 'PRODUCT', NULL, 0);
INSERT INTO `order_info` VALUES (337, 'DC17844315821730170', 10, 3, NULL, 1, 98.00, 'PENDING', 'UNPAID', NULL, NULL, NULL, NULL, NULL, NULL, '[规格:短款] ', '2026-07-19 11:26:22', '2026-07-19 11:26:22', 2, 'DOOR_TO_DOOR', 2, 'SERVICE', '2026-07-22', 0);
INSERT INTO `order_info` VALUES (338, 'DC17844315822028826', 10, 2, NULL, 1, 69.00, 'READY_RETURN', 'PAID', '2026-07-19 11:26:27', NULL, NULL, NULL, NULL, NULL, '[规格:短款] ', '2026-07-19 11:26:22', '2026-07-19 11:28:08', 2, 'DOOR_TO_DOOR', 2, 'SERVICE', '2026-07-22', 0);
INSERT INTO `order_info` VALUES (339, 'DC178443158221967F0', 10, NULL, 1, 1, 39.90, 'PENDING', 'UNPAID', NULL, NULL, NULL, NULL, NULL, NULL, '', '2026-07-19 11:26:22', '2026-07-19 11:26:22', 2, 'DOOR_TO_DOOR', NULL, 'PRODUCT', NULL, 0);
INSERT INTO `order_info` VALUES (340, 'DC17844315822373BAA', 10, NULL, 2, 2, 59.80, 'PENDING', 'UNPAID', NULL, NULL, NULL, NULL, NULL, NULL, '', '2026-07-19 11:26:22', '2026-07-19 11:26:22', 2, 'DOOR_TO_DOOR', NULL, 'PRODUCT', NULL, 0);
INSERT INTO `order_info` VALUES (341, 'DC178444293412105C4', 10, 2, NULL, 1, 69.00, 'AWAIT_PICKUP', 'PAID', '2026-07-19 14:35:41', NULL, NULL, NULL, NULL, NULL, '[规格:短款] ', '2026-07-19 14:35:34', '2026-07-19 14:35:41', 2, 'DOOR_TO_DOOR', 2, 'SERVICE', '2026-07-24', 1);
INSERT INTO `order_info` VALUES (342, 'DC1784443038273F6A1', 10, 1, NULL, 1, 99.00, 'AWAIT_PICKUP', 'PAID', '2026-07-19 14:37:23', NULL, NULL, NULL, NULL, NULL, '[规格:上衣+裤子套装] ', '2026-07-19 14:37:18', '2026-07-19 14:37:23', 2, 'DOOR_TO_DOOR', 2, 'SERVICE', '2026-07-22', 0);
INSERT INTO `order_info` VALUES (343, 'DC1784443061259387D', 10, 1, NULL, 1, 99.00, 'AWAIT_DROP', 'PAID', '2026-07-19 14:37:46', NULL, NULL, NULL, NULL, NULL, '[规格:上衣+裤子套装] ', '2026-07-19 14:37:41', '2026-07-19 14:37:46', 2, 'IN_STORE', 2, 'SERVICE', '2026-07-22', 0);
INSERT INTO `order_info` VALUES (344, 'DC1784443081929BF68', 29, 1, NULL, 1, 69.00, 'AWAIT_PICKUP', 'PAID', '2026-07-19 14:38:10', NULL, NULL, NULL, NULL, NULL, '[规格:上衣] ', '2026-07-19 14:38:02', '2026-07-19 14:38:10', 17, 'DOOR_TO_DOOR', 2, 'SERVICE', '2026-07-22', 0);
INSERT INTO `order_info` VALUES (345, 'DC17844430821125948', 29, NULL, 2, 1, 29.90, 'AWAIT_SHIP', 'PAID', '2026-07-19 14:38:06', NULL, NULL, NULL, NULL, NULL, NULL, '2026-07-19 14:38:02', '2026-07-19 14:38:06', 17, 'DOOR_TO_DOOR', 2, 'PRODUCT', NULL, 0);
INSERT INTO `order_info` VALUES (346, 'DC178444325243852F5', 10, 1, NULL, 1, 99.00, 'AWAIT_PICKUP', 'PAID', '2026-07-19 14:40:59', NULL, NULL, NULL, NULL, NULL, '[规格:上衣+裤子套装] ', '2026-07-19 14:40:52', '2026-07-19 14:41:00', 2, 'DOOR_TO_DOOR', 2, 'SERVICE', '2026-07-22', 0);
INSERT INTO `order_info` VALUES (347, 'DC1784443252463F743', 10, 1, NULL, 1, 69.00, 'AWAIT_PICKUP', 'PAID', '2026-07-19 14:40:57', NULL, NULL, NULL, NULL, NULL, '[规格:上衣] ', '2026-07-19 14:40:52', '2026-07-19 14:40:57', 2, 'DOOR_TO_DOOR', 2, 'SERVICE', '2026-07-22', 0);
INSERT INTO `order_info` VALUES (348, 'DC1784443393514E876', 10, 1, NULL, 1, 99.00, 'AWAIT_PICKUP', 'PAID', '2026-07-19 14:43:19', NULL, NULL, NULL, NULL, NULL, '[规格:上衣+裤子套装] ', '2026-07-19 14:43:14', '2026-07-19 14:43:19', 2, 'DOOR_TO_DOOR', 2, 'SERVICE', '2026-07-22', 0);
INSERT INTO `order_info` VALUES (349, 'DC178444505178229BE', 10, 1, NULL, 1, 69.00, 'AWAIT_PICKUP', 'PAID', '2026-07-19 15:10:57', NULL, NULL, NULL, NULL, NULL, '[规格:上衣] ', '2026-07-19 15:10:52', '2026-07-19 15:10:57', 2, 'DOOR_TO_DOOR', 2, 'SERVICE', '2026-07-22', 0);
INSERT INTO `order_info` VALUES (350, 'DC17844526826975DA7', 29, NULL, 1, 1, 39.90, 'AWAIT_SHIP', 'PAID', '2026-07-19 17:18:07', NULL, NULL, NULL, NULL, NULL, NULL, '2026-07-19 17:18:03', '2026-07-19 17:18:07', 17, 'DOOR_TO_DOOR', 2, 'PRODUCT', NULL, 0);
INSERT INTO `order_info` VALUES (351, 'DC1784452683033F0AA', 29, NULL, 2, 1, 29.90, 'AWAIT_SHIP', 'PAID', '2026-07-19 17:18:10', NULL, NULL, NULL, NULL, NULL, NULL, '2026-07-19 17:18:03', '2026-07-19 17:18:10', 17, 'DOOR_TO_DOOR', 2, 'PRODUCT', NULL, 0);
INSERT INTO `order_info` VALUES (352, 'DC1784452713339BD4B', 29, 2, NULL, 1, 128.00, 'CANCELLED', 'UNPAID', NULL, NULL, NULL, NULL, NULL, NULL, '[规格:加长款(过膝)] ', '2026-07-19 17:18:33', '2026-07-19 17:18:49', 17, 'DOOR_TO_DOOR', 2, 'SERVICE', '2026-07-24', 1);
INSERT INTO `order_info` VALUES (353, 'DC1784452873379E9D9', 29, 15, NULL, 1, 38.00, 'AWAIT_PICKUP', 'PAID', '2026-07-19 17:21:17', NULL, NULL, NULL, NULL, NULL, '[规格:篮球鞋] ', '2026-07-19 17:21:13', '2026-07-19 17:21:17', 17, 'DOOR_TO_DOOR', 2, 'SERVICE', '2026-07-24', 0);
INSERT INTO `order_info` VALUES (354, 'DC1784458620311EDB3', 10, 3, NULL, 1, 98.00, 'CANCELLED', 'UNPAID', NULL, NULL, NULL, NULL, NULL, NULL, '[规格:短款] ', '2026-07-19 18:57:00', '2026-07-19 18:57:08', 2, 'DOOR_TO_DOOR', 2, 'SERVICE', '2026-07-24', 0);
INSERT INTO `order_info` VALUES (355, 'DC17844611967487A47', 10, 3, NULL, 1, 158.00, 'PENDING', 'UNPAID', NULL, NULL, NULL, NULL, NULL, NULL, '[规格:长款] ', '2026-07-19 19:39:57', '2026-07-19 19:39:57', 2, 'DOOR_TO_DOOR', 2, 'SERVICE', '2026-07-22', 0);
INSERT INTO `order_info` VALUES (356, 'DC17844611968495DD1', 10, NULL, 1, 1, 39.90, 'PENDING', 'UNPAID', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-07-19 19:39:57', '2026-07-19 19:39:57', 2, 'DOOR_TO_DOOR', 2, 'PRODUCT', NULL, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '套卷/试卷表' ROW_FORMAT = Dynamic;
...
INSERT INTO `payment_record` VALUES (275, 321, NULL, 10, 69.00, 'PENDING', 'SIMULATE', '2026-03-23 16:43:11', NULL);
INSERT INTO `payment_record` VALUES (276, 323, NULL, 10, 69.00, 'PAID', 'WECHAT', '2026-07-18 12:47:59', '2026-07-18 12:48:02');
INSERT INTO `payment_record` VALUES (277, 329, NULL, 10, 69.00, 'PAID', 'WECHAT', '2026-07-18 14:07:21', '2026-07-18 14:07:24');
INSERT INTO `payment_record` VALUES (278, 330, NULL, 10, 39.90, 'PAID', 'WECHAT', '2026-07-18 15:08:04', '2026-07-18 15:09:17');
INSERT INTO `payment_record` VALUES (279, 331, NULL, 10, 28.00, 'PAID', 'ALIPAY', '2026-07-18 16:16:04', '2026-07-18 16:16:05');
INSERT INTO `payment_record` VALUES (280, 332, NULL, 10, 98.00, 'PENDING', 'SIMULATE', '2026-07-18 16:16:48', NULL);
INSERT INTO `payment_record` VALUES (281, 335, NULL, 29, 69.00, 'PAID', 'WECHAT', '2026-07-19 11:26:02', '2026-07-19 11:26:03');
INSERT INTO `payment_record` VALUES (282, 336, NULL, 29, 39.90, 'PAID', 'WECHAT', '2026-07-19 11:26:05', '2026-07-19 11:26:06');
INSERT INTO `payment_record` VALUES (283, 334, NULL, 29, 25.00, 'PAID', 'WECHAT', '2026-07-19 11:26:07', '2026-07-19 11:26:08');
INSERT INTO `payment_record` VALUES (284, 338, NULL, 10, 69.00, 'PAID', 'ALIPAY', '2026-07-19 11:26:26', '2026-07-19 11:26:27');
INSERT INTO `payment_record` VALUES (285, 341, NULL, 10, 69.00, 'PAID', 'WECHAT', '2026-07-19 14:35:39', '2026-07-19 14:35:41');
INSERT INTO `payment_record` VALUES (286, 342, NULL, 10, 99.00, 'PAID', 'WECHAT', '2026-07-19 14:37:21', '2026-07-19 14:37:23');
INSERT INTO `payment_record` VALUES (287, 343, NULL, 10, 99.00, 'PAID', 'WECHAT', '2026-07-19 14:37:44', '2026-07-19 14:37:46');
INSERT INTO `payment_record` VALUES (288, 345, NULL, 29, 29.90, 'PAID', 'WECHAT', '2026-07-19 14:38:05', '2026-07-19 14:38:06');
INSERT INTO `payment_record` VALUES (289, 344, NULL, 29, 69.00, 'PAID', 'WECHAT', '2026-07-19 14:38:08', '2026-07-19 14:38:10');
INSERT INTO `payment_record` VALUES (290, 346, NULL, 10, 99.00, 'PAID', 'ALIPAY', '2026-07-19 14:40:53', '2026-07-19 14:40:59');
INSERT INTO `payment_record` VALUES (291, 347, NULL, 10, 69.00, 'PAID', 'ALIPAY', '2026-07-19 14:40:53', '2026-07-19 14:40:57');
INSERT INTO `payment_record` VALUES (292, 348, NULL, 10, 99.00, 'PAID', 'WECHAT', '2026-07-19 14:43:16', '2026-07-19 14:43:19');
INSERT INTO `payment_record` VALUES (293, 349, NULL, 10, 69.00, 'PAID', 'WECHAT', '2026-07-19 15:10:55', '2026-07-19 15:10:57');
INSERT INTO `payment_record` VALUES (294, 350, NULL, 29, 39.90, 'PAID', 'WECHAT', '2026-07-19 17:18:05', '2026-07-19 17:18:07');
INSERT INTO `payment_record` VALUES (295, 351, NULL, 29, 29.90, 'PAID', 'WECHAT', '2026-07-19 17:18:09', '2026-07-19 17:18:10');
INSERT INTO `payment_record` VALUES (296, 353, NULL, 29, 38.00, 'PAID', 'WECHAT', '2026-07-19 17:21:16', '2026-07-19 17:21:17');
...
) ENGINE = InnoDB AUTO_INCREMENT = 185 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '消息通知表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_notification` VALUES (163, 10, '支付成功', '订单 DC17752207812815B20 已支付成功。', 'ORDER', 323, 0, '2026-07-18 12:48:02');
INSERT INTO `sys_notification` VALUES (164, 10, '支付成功', '订单 DC178435483761857CA 已支付成功。', 'ORDER', 329, 0, '2026-07-18 14:07:24');
INSERT INTO `sys_notification` VALUES (165, 10, '支付成功', '订单 DC1784354837663113F 已支付成功。', 'ORDER', 330, 0, '2026-07-18 15:09:17');
INSERT INTO `sys_notification` VALUES (166, 10, '支付成功', '订单 DC178436256192596AC 已支付成功。', 'ORDER', 331, 0, '2026-07-18 16:16:05');
INSERT INTO `sys_notification` VALUES (167, 29, '支付成功', '订单 DC1784431559509F8B4 已支付成功。', 'ORDER', 335, 0, '2026-07-19 11:26:03');
INSERT INTO `sys_notification` VALUES (168, 29, '支付成功', '订单 DC17844315595828046 已支付成功。', 'ORDER', 336, 0, '2026-07-19 11:26:06');
INSERT INTO `sys_notification` VALUES (169, 29, '支付成功', '订单 DC1784431559417BF4A 已支付成功。', 'ORDER', 334, 0, '2026-07-19 11:26:08');
INSERT INTO `sys_notification` VALUES (170, 10, '支付成功', '订单 DC17844315822028826 已支付成功。', 'ORDER', 338, 0, '2026-07-19 11:26:27');
INSERT INTO `sys_notification` VALUES (171, 10, '支付成功', '订单 DC178444293412105C4 已支付成功。', 'ORDER', 341, 0, '2026-07-19 14:35:41');
INSERT INTO `sys_notification` VALUES (172, 10, '支付成功', '订单 DC1784443038273F6A1 已支付成功。', 'ORDER', 342, 0, '2026-07-19 14:37:23');
INSERT INTO `sys_notification` VALUES (173, 10, '支付成功', '订单 DC1784443061259387D 已支付成功。', 'ORDER', 343, 0, '2026-07-19 14:37:46');
INSERT INTO `sys_notification` VALUES (174, 29, '支付成功', '订单 DC17844430821125948 已支付成功。', 'ORDER', 345, 0, '2026-07-19 14:38:06');
INSERT INTO `sys_notification` VALUES (175, 29, '支付成功', '订单 DC1784443081929BF68 已支付成功。', 'ORDER', 344, 0, '2026-07-19 14:38:10');
INSERT INTO `sys_notification` VALUES (176, 10, '支付成功', '订单 DC1784443252463F743 已支付成功。', 'ORDER', 347, 0, '2026-07-19 14:40:57');
INSERT INTO `sys_notification` VALUES (177, 10, '支付成功', '订单 DC178444325243852F5 已支付成功。', 'ORDER', 346, 0, '2026-07-19 14:40:59');
INSERT INTO `sys_notification` VALUES (178, 10, '支付成功', '订单 DC1784443393514E876 已支付成功。', 'ORDER', 348, 0, '2026-07-19 14:43:19');
INSERT INTO `sys_notification` VALUES (179, 10, '支付成功', '订单 DC178444505178229BE 已支付成功。', 'ORDER', 349, 0, '2026-07-19 15:10:57');
INSERT INTO `sys_notification` VALUES (180, 29, '支付成功', '订单 DC17844526826975DA7 已支付成功。', 'ORDER', 350, 0, '2026-07-19 17:18:07');
INSERT INTO `sys_notification` VALUES (181, 29, '支付成功', '订单 DC1784452683033F0AA 已支付成功。', 'ORDER', 351, 0, '2026-07-19 17:18:10');
INSERT INTO `sys_notification` VALUES (182, 29, '订单取消', '订单 DC1784452713339BD4B 已取消。', 'ORDER', 352, 0, '2026-07-19 17:18:49');
INSERT INTO `sys_notification` VALUES (183, 29, '支付成功', '订单 DC1784452873379E9D9 已支付成功。', 'ORDER', 353, 0, '2026-07-19 17:21:17');
INSERT INTO `sys_notification` VALUES (184, 10, '订单取消', '订单 DC1784458620311EDB3 已取消。', 'ORDER', 354, 0, '2026-07-19 18:57:08');
...
INSERT INTO `sys_user` VALUES (29, 'su', '$2a$10$CQck/Rtainb1dyNjGE8hLekW9Tu4w8hjVYFjn3riUtDHmcc8pSMb2', NULL, '15133261531', 'USER', 1, '2026-07-19 10:12:37', '2026-07-19 10:12:37', NULL);
...
INSERT INTO `user_address` VALUES (2, 10, '伊一', '16798612591', '陕西省', '宝鸡市', '陈仓区', '学府路', 1, '2026-03-07 18:46:04', '2026-03-31 15:47:07');
...
INSERT INTO `user_address` VALUES (17, 29, '王', '15133261531', '河北省', '石家庄市', '新华区', '河北经贸大学', 0, '2026-07-19 11:24:13', '2026-07-19 11:24:13');
